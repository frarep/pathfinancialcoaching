export default function StructuredData() {
  const structuredData = {
    ...
    description: 'Financial coaching services helping individuals and families achieve financial freedom through budgeting, debt elimination, and wealth building.',
