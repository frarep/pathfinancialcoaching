  ...
  const processSteps = [
    {
      ...
      backgroundImage: "/images/lone-tree-optimized.jpg",
      backgroundImageWebp: "/images/lone-tree-optimized.webp"
    },
    {
      ...
      backgroundImage: "/images/sunset-clouds-optimized.jpg",
      backgroundImageWebp: "/images/sunset-clouds-optimized.webp"
    },
    {
      ...
      backgroundImage: "/images/ocean-boardwalk-optimized.jpg",
      backgroundImageWebp: "/images/ocean-boardwalk-optimized.webp"
    },
    {
      ...
      backgroundImage: "/images/galaxy-cluster-optimized.jpg",
      backgroundImageWebp: "/images/galaxy-cluster-optimized.webp"
    }
  ]
          ...
          {processSteps.map((step, index) => (
            ...
            >
              <button
                ...
                className="relative h-64 sm:h-72 md:h-80 w-full flex flex-col items-center justify-center text-center cursor-pointer overflow-hidden rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 border-2 border-transparent hover:border-soft-blue/30"
                aria-expanded={expandedCard === index}
                aria-label={`Learn more about ${step.title}`}
              >
                {/* Background Image */}
                <picture className="absolute inset-0">
                  <source srcSet={step.backgroundImageWebp} type="image/webp" />
                  <img
                ...
                >
                  ...
                  <h3 className="text-lg sm:text-2xl md:text-3xl font-bold text-gray-800 uppercase drop-shadow-sm">{step.title}</h3>
                  <p className="text-xs sm:text-sm text-gray-600 mt-2">Tap to learn more</p>
                </div>
        ...
        <div className="grid md:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          {testimonials.map((testimonial, index) => (
            <div key={index} className="relative rounded-xl overflow-hidden shadow-lg transition-all duration-300 hover:shadow-2xl">
              {/* Background Image */}
              <picture className="absolute inset-0">
                <source srcSet="/images/balloons-optimized.webp" type="image/webp" />
                <img
                  src="/images/balloons-optimized.jpg"
                  alt=""
                  className="absolute inset-0 w-full h-full object-cover"
                />
              </picture>
              ...
              <div className="relative p-4 sm:p-6 md:p-8">
                ...
                <p className="text-xs sm:text-sm md:text-base text-gray-800 mb-4 italic leading-relaxed font-medium">
                  {testimonial.quote}
                </p>
