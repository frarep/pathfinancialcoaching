        ...
        <div className="grid md:grid-cols-2 gap-12 items-start max-w-6xl mx-auto">
          ...
          <div className="order-2 md:order-2">
            <div className="space-y-6 text-lg text-gray-900 leading-relaxed font-medium">
              <p>
                Hi, I'm Coach Patrick. I am a Dave Ramsey trained financial coach and I am excited to work with you to identify your dreams and help you build the path to achieving them. I have a passion for helping and serving others so when I tell you that I am here to walk with you and help, it comes from the heart. I have faced debt, poor money habits, anxiety about savings and retirement, car troubles, work insecurity, feeling like we would never get ahead and achieve our dreams. I have felt anxious, depressed, angry, and hopelessness at the situations in front of me, just like you may be feeling now. What was true for me that is also true for you is that there is a positive way out to peace, success, and the fulfillment of your dreams. As a father, husband, firefighter, veteran, friend, coach, I am here to walk with you through issues like these, to make a plan and achieve your dreams. I have been serving others for many years, assisting them in making a plan and executing it to get out of debt, save for retirement, save for kids college, save to buy a house and to pay off the mortgage early, as well as helping to bring peace to stress-filled lives. If you are looking for someone who can help you take your dreams from wishful thinking to reality, then schedule a call with me and lets get going!
              </p>
              <p>
